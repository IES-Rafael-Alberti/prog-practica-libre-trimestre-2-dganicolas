...
sealed class Luchadores(val nombre: String,var monedas: Float, var nivel: Int, var dano: Float, var vida: Float, var vidaActual: Float, var arma: Armas):registrarAccion{
